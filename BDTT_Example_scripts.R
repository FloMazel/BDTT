...
lapply(slices,GetBranchOcc,tree=TreeExmple,sitesp=SiteSpExmple,pathtoSaveBranchOcc="",bigmatrix=T)
lapply(slices,GetBetaDiv,pathtoGetBranchOcc="",pathtoSaveBeta="")
...
lapply(seq(from=0,to=5, by=0.5),GetBranchOcc,tree=TreeExmple,sitesp=SiteSpExmple,pathtoSaveBranchOcc="",bigmatrix=F)
