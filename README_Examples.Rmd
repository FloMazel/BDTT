...
#### 1. [The BDTT function](#Functions)

#### 2. [Example](#Example)


## 1. The BDTT function <a name="Functions"></a>

You will need to install and load the follwing R packages: 
...
The BDTT function requires the follwing inputs: 
